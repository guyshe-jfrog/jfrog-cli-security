...
func (scanCmd *ScanCommand) Run() (err error) {
	...
	if scanResults.ExtendedScanResults.EntitledForJas {
		...
		scanResults.JasError = runner.RunJasScannersAndSetResults(scanResults, depsList, scanCmd.serverDetails, workingDirs, nil, false, "XrayGraphScanParams().MultiScanId", applicability.ApplicabilityDockerScanScanType, secrets.SecretsScannerDockerScanType)
	}
